...
print tagPOS(tokenize("Bayesian Statistical Model"), []);
#print tagPOS(tokenize("Autonomous Helicopter Aerobatics"), []);
#print tagPOS(tokenize("Quantified Differential Dynamic Logic for Distributed Hybrid Systems"), []);